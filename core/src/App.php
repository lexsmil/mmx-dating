...
class App
{
    public const NAME = 'mmxDating';
    public const NAMESPACE = 'mmx-dating';
    ...
    public function __construct(modX $modx)
    {
        ...
        if (!$this->modx->services->has('mmxDatabase')) {
            $this->modx->log(modX::LOG_LEVEL_ERROR, 'Please install "mmx/database" package to use mmxDating');
        }
    ...
    public function handleSnippet(array $properties): string
    {
        ...
        return '<div id="mmx-dating-root"></div>';
    }
    ...
    protected static function setRoutes(\Slim\App $app): void
    {
        $app->group(
            ...
            static function (RouteCollectorProxy $group) {
                $group->any('/events[/{id:\d+}]', Controllers\Mgr\Events::class);
                $group->any('/requests[/{id:\d+}]', Controllers\Mgr\Requests::class);
            }
